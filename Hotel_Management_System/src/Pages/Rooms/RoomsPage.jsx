...
const RoomsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-stone-950 text-white selection:bg-amber-500 selection:text-white pt-4 pb-12 sm:pt-8">
      ...
      <div className="relative mx-auto max-w-[1400px] px-4 sm:px-10">
        ...
        <div className="mb-4 flex justify-between items-center relative z-50 sm:mb-8">
          <div>
            <button 
              onClick={() => navigate("/")}
              aria-label="Back to Home"
              className="group flex shrink-0 items-center gap-2 rounded-full border border-white/10 bg-black/40 p-3 text-sm font-semibold text-stone-300 backdrop-blur-md transition-all hover:bg-white/10 hover:text-white hover:border-white/20 sm:px-5 sm:py-2.5"
            >
