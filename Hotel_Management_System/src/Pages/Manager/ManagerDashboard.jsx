  ...
  return (
    <div className="animate-in fade-in zoom-in duration-500 space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
        <Link to="/employee/panel/bookings?status=booked" className="rounded-2xl border border-white/10 bg-black/40 backdrop-blur-md p-6 hover:border-amber-500/40 transition-colors">
          <div className="flex items-center justify-between text-stone-400">
            <span className="text-xs font-semibold uppercase tracking-wider">Upcoming arrivals</span>
            <FiLogIn className="h-5 w-5 text-amber-400" />
          </div>
          <p className="mt-3 font-serif text-3xl font-bold text-white">{stats.upcomingArrivals}</p>
          <p className="mt-1 text-[11px] text-stone-500">Paid bookings waiting for check-in</p>
        </Link>
        <Link to="/employee/panel/bookings?status=checkedIn" className="rounded-2xl border border-white/10 bg-black/40 backdrop-blur-md p-6 hover:border-amber-500/40 transition-colors">
          <div className="flex items-center justify-between text-stone-400">
            <span className="text-xs font-semibold uppercase tracking-wider">Guests in house</span>
            <FiUsers className="h-5 w-5 text-blue-400" />
          </div>
          <p className="mt-3 font-serif text-3xl font-bold text-white">{stats.checkedIn}</p>
          <p className="mt-1 text-[11px] text-stone-500">Currently checked in</p>
        </Link>
        <Link to="/employee/panel/bookings" className="rounded-2xl border border-white/10 bg-black/40 backdrop-blur-md p-6 hover:border-amber-500/40 transition-colors">
          <div className="flex items-center justify-between text-stone-400">
          ...
          <p className="mt-3 font-serif text-3xl font-bold text-white">{stats.totalBookings}</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 rounded-2xl border border-white/10 bg-black/40 backdrop-blur-md p-6">
        ...
        <div className="rounded-2xl border border-white/10 bg-black/40 backdrop-blur-md p-6 space-y-3">
